...
class T(unittest.TestCase):
    ...
    def test_workday(self):
        ...
        with freeze_time('2017-06-16 13:40:26'):  # Friday
            ...
            self.assert_date('1 workday ago', datetime(2017, 6, 15, 13, 40, 26))
            ...
            self.assert_date('1 workday from now', datetime(2017, 6, 19, 13, 40, 26))
        ...
        for dt_str in ('2017-06-17 11:05:21', '2017-06-18 11:05:21'):
            with freeze_time(dt_str):  # Saturday, Sunday
                ...
                self.assert_date('1 workday ago', datetime(2017, 6, 16, 11, 5, 21))
                ...
                self.assert_date('1 workday from now', datetime(2017, 6, 19, 11, 5, 21))
        ...
        with freeze_time('2017-06-19 13:01:50'):  # Monday
            ...
            self.assert_date('1 workday ago', datetime(2017, 6, 16, 13, 1, 50))
            ...
            self.assert_date('1 workday from now', datetime(2017, 6, 20, 13, 1, 50))
