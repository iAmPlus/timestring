...
class T(unittest.TestCase):
    ...
    def test_workday(self):
        ...
        for dt_str in ('2017-06-17 19:37:22', '2017-06-18 19:37:22'):
            with freeze_time(dt_str):  # Saturday, Sunday
                self.assert_date('previous workday', datetime(2017, 6, 16))
                self.assert_date('1 workdays ago', datetime(2017, 6, 16))
                self.assert_date('2 workdays ago', datetime(2017, 6, 15))
                self.assert_date('3 workdays ago', datetime(2017, 6, 14))
                self.assert_date('4 workdays ago', datetime(2017, 6, 13))
                self.assert_date('5 workdays ago', datetime(2017, 6, 12))
        ...
        with freeze_time('2017-06-19 13:01:50'):  # Monday
            ...
            self.assert_date('1 workdays from now', datetime(2017, 6, 20))
            self.assert_date('2 workdays from now', datetime(2017, 6, 21))
            self.assert_date('3 workdays from now', datetime(2017, 6, 22))
            self.assert_date('4 workdays from now', datetime(2017, 6, 23))
            self.assert_date('5 workdays from now', datetime(2017, 6, 26))
