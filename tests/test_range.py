...
class T(unittest.TestCase):
    ...
    def test_workday(self):
        with freeze_time('2017-06-16 13:40:26'):  # Friday
            ...
            self.assert_range('previous 1 workday', datetime(2017, 6, 15), datetime(2017, 6, 16))
            ...
            self.assert_range('1 workday ago', datetime(2017, 6, 15), datetime(2017, 6, 16))
            ...
            self.assert_range('next 1 workday', datetime(2017, 6, 19), datetime(2017, 6, 20))
            ...
            self.assert_range('1 workday from now', datetime(2017, 6, 19), datetime(2017, 6, 20))
        ...
        for dt_str in ('2017-06-17 11:05:21', '2017-06-18 11:05:21'):
            with freeze_time(dt_str):  # Saturday, Sunday
                ...
                self.assert_range('previous 1 workday', datetime(2017, 6, 16), datetime(2017, 6, 17))
                ...
                self.assert_range('1 workday ago', datetime(2017, 6, 16), datetime(2017, 6, 17))
        ...
        with freeze_time('2017-06-19 13:01:50'):  # Monday
            ...
            self.assert_range('next 1 workday', datetime(2017, 6, 20), datetime(2017, 6, 21))
            ...
            self.assert_range('1 workday from now', datetime(2017, 6, 20), datetime(2017, 6, 21))
